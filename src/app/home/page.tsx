      ...
      <section className="grid grid-cols-2 gap-6 p-6">
        ...
        <div className="bg-gray-300 text-center p-10 rounded shadow-md flex items-center justify-center aspect-square">
          <Link href="/products/candytoys" className="font-bold text-lg">
            <Image src="/products/funtubes.jpg" alt="Candy Toys" width={800} height={800} className="mb-2" priority />
            Candy Toys
          </Link>
        </div>
        <div className="bg-gray-300 text-center p-10 rounded shadow-md flex items-center justify-center aspect-square">
          <Link href="/products/joyful" className="font-bold text-lg">
            <Image src="/products/joyful logo.jpg" alt="Joyful" width={800} height={800} className="mb-2" priority />
            Joyful
          </Link>
        </div>
        <div className="bg-gray-300 text-center p-10 rounded shadow-md flex items-center justify-center aspect-square">
          <Link href="/products/lezzet" className="font-bold text-lg">
            <Image src="/products/Logo lezzet.png" alt="Lezzet" width={800} height={800} className="mb-2" priority />
            Lezzet
          </Link>
        </div>
      </section>
